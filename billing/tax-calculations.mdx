...
<img
  src="/images/Screenshot2025-04-24at2.49.00PM.png"
  alt="Add Custom Tax Rate"
...
You can assign tax rates to the following items. You can choose whether you want to apply a single tax rate or multiple tax rates.
