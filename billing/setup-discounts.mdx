...
<Steps>
  ...
  <Step title="Set Usage Limit">
    Set how many times the Discount Code can be used by the customers
  ...
  <Step title="Set Active Dates">
    ...
    You can also set an end date, post which the Discount will become Inactive and will no longer be available for usage.
  </Step>
</Steps>
