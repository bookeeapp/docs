...
<AccordionGroup>
  <Accordion title="Select the Ghost Client Follow-up Template">
  ...
  <Accordion title="Configure the Entry Rule – 'First Visit is More Than X Days Ago'">
  ...
  <Accordion title="Set Up Email Messaging">
  ...
  <Accordion title="Prepare Discounts in Advance">
