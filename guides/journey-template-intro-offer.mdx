...
Think of it as your automated sales assistant — checking in, celebrating visits, and pushing for subscriptions, all on autopilot.
...
<AccordionGroup>
  <Accordion title="Select the Intro Offer Journey Template" icon="plus">
    ...
    <Info>
      💡 Pair this with the Lead Nurture Journey to guide your leads end-to-end — from signup to sale.
    </Info>
  </Accordion>
  <Accordion title="Configure Rule Block - Intro Offer Purchased" icon="filter">
    Choose the specific **Intro Offer** from your pricing options. This ensures that only users who’ve bought this package will enter the journey.
  ...
  <Accordion title="Adjust Wait Nodes" icon="hand">
    ...
    - Adjust based on your customer’s typical booking window
  </Accordion>
...
- Re-engaging intro buyers who haven’t returned

The **Intro Offer Journey** helps your studio stay proactive, relevant, and persuasive — without sending a single manual follow-up. Launch yours today and watch your intro pack conversions soar 🚀