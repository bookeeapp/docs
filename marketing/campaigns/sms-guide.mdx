...
<Info>
  Every SMS campaign requires the rule **Opted-in for marketing** to comply with SMS regulations (A2P 10DLC, GDPR, TCPA).
</Info>
...
<Warning>
  Ensure your business has a verified A2P 10DLC registration to avoid message filtering or delivery blocks. Read [this guide](https://help.twilio.com/articles/1260801864489-How-do-I-register-to-use-A2P-10DLC-messaging).
</Warning>
