...
<Steps>
  ...
  <Step title="Enter Appointment Details">
    ...
    You can also choose whether or not to send a notification about the appointment to the customer(s).
  ...
  <Step title="Confirm Availability and Add Appointment">
    Review the slot availability and click **Add Appointment** to finalize. The system will highlight any conflicts with another event in case the Facility or the Instructor is not available.
  ...
  <Step title="Select Customer and Book" icon="user">
    Select the customer for the appointment and select a membership for them from which they wish to deduct credits.
...
<AccordionGroup>
  <Accordion title="Book Customers" icon="user-plus">
    In case the appointment allows for more than one customer to be booked (as set during appointment creation), more customers can be booked into the appointment.
