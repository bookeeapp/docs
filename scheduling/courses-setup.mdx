...
<AccordionGroup>
  ...
  <Accordion title="Instructor, Course Size & Type" icon="chalkboard-user">
    ...
    <Info>
      In case it is an online course, you will get the option to choose whether to add a Zoom link or add links to the session manually.
    </Info>
    <div className="flex justify-center mt-4">
      <img
  ...
  <Accordion title="Start & End Dates" icon="calendar">
    ...
    <Note>
      Additional sessions can be added to the Course past its end date after its creation. This does not change the Course's end date across CRM and customer-facing interfaces.
    </Note>
    <div className="flex justify-center mt-4">
      <img
