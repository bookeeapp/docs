...
<AccordionGroup>
  <Accordion title="Appointment Name" icon="boxing-glove">
    ...
    ![Screenshot2025 04 15at4 16 39PM Pn](/images/Screenshot2025-04-15at4.16.39PM.png)
  ...
  <Accordion title="Appointment Category" icon="icons">
    ...
    ![Screenshot2025 04 15at4 15 38PM Pn](/images/Screenshot2025-04-15at4.15.38PM.png)
  ...
  <Accordion title="Description" icon="pen-to-square">
    ...
    ![Screenshot2025 04 15at4 35 06PM Pn](/images/Screenshot2025-04-15at4.35.06PM.png)
  ...
  <Accordion title="Maximum Number of People Allowed" icon="users">
    ...
    ![Screenshot2025 04 15at4 35 43PM Pn](/images/Screenshot2025-04-15at4.35.43PM.png)
  ...
  <Accordion title="Online Appointment" icon="screen-users">
    Toggle this on if the appointment is delivered virtually. Kenko can generate Zoom links automatically (if integrated under Apps). You can also add links Manually to the appointments just like Classes.

    ![Screenshot2025 04 15at4 37 02PM Pn](/images/Screenshot2025-04-15at4.37.02PM.png)
  ...
  <Accordion title="Instructor Selection" icon="chalkboard-user">
    ...
    ![Screenshot2025 04 15at4 38 14PM Pn](/images/Screenshot2025-04-15at4.38.14PM.png)
  ...
  <Accordion title="Facility Selection" icon="house">
    ...
    <Note>
      Facility selection is disabled for **_online appointments._**
    </Note>
    <div className="flex justify-center" />
  </Accordion>
