...
description: "Learn how to manage, schedule, and edit course sessions directly from the calendar interface in Kenko."
---
...
<AccordionGroup>
  ...
  <Accordion title="Delete Course" icon="trash">
    In Kenko, you have the option to **delete** a course, depending on your needs. Here's what happens when you do
