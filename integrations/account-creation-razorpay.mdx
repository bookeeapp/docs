...
After connecting Razorpay, we recommend testing the integration

1. Go to **Admin Settings** \> **Billing & Payments** \> **Test Mode**
2. Toggle **Test Mode** to ON
3. Perform a test transaction using Razorpay's [test card numbers](https://razorpay.com/docs/payments/payment-gateway/test-card-details/)
   - Test successful payment: 4111 1111 1111 1111
   - Test failed payment: 4000 0000 0000 0002
4. Verify the test transaction appears in both Kenko and your Razorpay dashboard
...
<AccordionGroup>
  ...
  <Accordion title="Disconnection Issues" icon="link-slash">
    If your Razorpay account becomes disconnected, re-enter your API credentials in Kenko's payment settings.
  </Accordion>
...
### Disconnecting Razorpay

If you need to disconnect your Razorpay account

1. Go to **Admin Settings** \> **Billing & Payments** \> **Payment Processing**
2. Click **Disconnect** next to your Razorpay connection
3. Confirm the disconnection

<Warning>
  Disconnecting your Razorpay account will prevent all future payments from processing. Only disconnect if you're switching payment processors or closing your account.
</Warning>
...
_Note: Fees are subject to change. Please refer to Razorpay's official pricing page for the most up-to-date information._
...
<CardGroup cols={2}>
  ...
  <Card title="Verify Signatures" icon="file-signature">
