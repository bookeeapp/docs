...
<CardGroup cols="2">
  <Card title="Tasks" icon="circle-check" href="/admin/task-managment">
...
<CardGroup cols="2">
  <Card title="Staff Attendance" icon="user-check" href="/admin/staff-attendance">
    Track your staff's attendance, working hours, and manage time-offs.
  </Card>
  <Card title="Customer Check-In" icon="person-walking-arrow-right">
...
<Steps>
  <Step title="Customize Communications" stepNumber={1}>
    Set up your [email templates](/marketing/campaigns/email-setup-guide) for member communications.
  </Step>
  <Step title="Enable Auto-messages" stepNumber={2}>
    Set up notifications for your staff and customers.
  </Step>
  <Step title="Setup Marketing efforts">
    Kenko is powered by powerful Journeys, Reserve with Google and Campaigns. Setting these up the right way can do wonders for your business.
  </Step>
</Steps>
