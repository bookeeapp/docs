...
Kenko requires all virtual phone numbers sending SMS in the US to be A2P 10DLC compliant. The registration process is handled via a wizard in Kenko’s SMS Settings.
