...
## How to Set Up Custom Email in Kenko
...
- Email forwarding (especially Gmail) for the AI Inbox
...
<AccordionGroup>
  ...
  <Accordion title="Adding a new Domain" icon="plus">
    You can simply add a new domain by clicking **Add Domain** and entering your business's domain, which is used in your email address.
...
<CardGroup cols={2}>
  <Card title="Domain Authentication" icon="shield-check" href="#domain-authentication">
  ...
  <Card title="Email Forwarding" icon="arrow-right" href="#email-forwarding">
  ...
  <Card title="Sender Email Addresses" icon="envelope" href="#sender-email-addresses">
  ...
  <Card title="General Recommendations" icon="cog">
