...
<Steps>
  ...
  <Step title="Assign to Staff">
    Go to Staff → Edit Staff and assign the appropriate role from the dropdown. Or, when adding a new staff member, assign them a role directly.
  </Step>
</Steps>
...
Need help planning your roles and team structure? Contact [support@gokenko.com](mailto:support@gokenko.com) — we’re happy to advise based on your business model.