...
<Note>
  Check out this video on how to embed the website widget into your Squarespace website.
</Note>
...
- **Magic Links**: Deep links to specific memberships or offerings (see [Magic Links in Kenko](./magic-links))
...
If you run into issues embedding the widget or setting up navigation:
