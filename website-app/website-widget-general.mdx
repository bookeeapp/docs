...
Integrate your Kenko booking widget into your custom website to provide clients with a seamless booking and browsing experience—without ever leaving your domain. This guide walks you through connecting your domain, enabling SSL, and configuring SEO using any modern website builder.
...
1. **Access to Existing Website Platform**\
   Request access to the customer’s website builder account (e.g., Wix, Squarespace, Webflow). Use: `success@gokenko.com`.
...
<Check>
  👉 Step 1 and 2 should be completed well before the go-live date. Ensure all inputs are collected early and questions are resolved in advance.
</Check>

<Check>
  👉 Step 3 and 4 should be performed on the day of go-live to ensure the latest changes are reflected live.
</Check>
...
<Steps>
  ...
  <Step title="Step 2: Publish the Site">
    - After updating DNS records, publish your website from your website builder’s editor.
...
<Info>
  Contact [support@gokenko.community](mailto:support@gokenko.community) and share your domain provider details and screenshots of current DNS records.
</Info>

Once completed, your Kenko widget will be live on your website—fully secure, SEO-ready, and ready to handle bookings, pricing, and client interactions.