...
<AccordionGroup>
  <Accordion title="View today's class and appointment schedule" icon="calendar">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot_20250507_121432_KenkoBusiness.jpg" className=" rounded-lg" max-width="300px" alt="Calendar view" />
    </div>
  </Accordion>
  <Accordion title="Filter by Facility & Instructor" icon="filter">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot2025-05-07at12.20.20PM.png" className="w-[500px] rounded-lg" alt="Calendar filter" />
    </div>
  </Accordion>
  ...
  <Accordion title="Add members to session" icon="badge-check">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_121527_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Add member to session" />
    </div>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Search by name, phone, or email" icon="building-magnifying-glass">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_132143_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Search contact" />
    </div>
  </Accordion>
  <Accordion title="View Booking Details" icon="id-card">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_133902_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Booking details" />
    </div>
  </Accordion>
  <Accordion title="Check-in clients manually" icon="user-check">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_121539_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Manual check-in" />
    </div>
  </Accordion>
  <Accordion title="View Notes and Contact Timeline" icon="file-lines">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_133914_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Member notes" />
    </div>
  </Accordion>
  <Accordion title="View Member's Membership Details" icon="money-bill-simple-wave">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_132309_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Membership details" />
    </div>
  </Accordion>
  <Accordion title="Access Payment Details" icon="address-card">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_133910_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Payment details" />
    </div>
  </Accordion>
  <Accordion title="Document and Waivers for Members" icon="file-contract">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_133925_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Waivers and forms" />
    </div>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Choose a member to start a sale" icon="user-plus">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_152451_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Select member for sale" />
    </div>
  </Accordion>
  <Accordion title="Sell Memberships" icon="ticket">
    ...
    <div className="flex justify-center">
      <img src="/images/Screenshot20250507_152459_KenkoBusiness.jpg" className="w-[500px] rounded-lg" alt="Sell memberships" />
    </div>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Refer and Earn" icon="square-user">
    Staff referrals earn rewards when they bring in new members or suggest Kenko to others.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Class" icon="users-line">
    Create a new class session directly on the app.
  </Accordion>
