...
<AccordionGroup>
  ...
  <Accordion title="View Membership and Booking Details" icon="id-card">
  ...
  <Accordion title="View Member Profile & Memberships" icon="street-view">
    
  </Accordion>
  <Accordion title="View Member's Payment Details" icon="money-bill-simple-wave">
