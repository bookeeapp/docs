...
<table data-view="cards"><thead><tr><th>Section</th><th data-card-target data-type="content-ref">Open</th></tr></thead><tbody><tr><td><strong>Documentation</strong><br>Product docs by module.</td><td><a href="/broken/spaces/i5uRkeW8EPGpQhS9SwGb/pages/cvNw17fbQ5DurtlLgnI4">Broken link</a></td></tr><tr><td><strong>Guides</strong><br>Step-by-step playbooks and best practices.</td><td><a href="/broken/spaces/i5uRkeW8EPGpQhS9SwGb/pages/x8leVbtnJNhipNRO4rD8">Broken link</a></td></tr><tr><td><strong>FAQs</strong><br>Quick answers and troubleshooting.</td><td><a href="/broken/spaces/i5uRkeW8EPGpQhS9SwGb/pages/Cgmv9iWj2wnapNEZ6wmF">Broken link</a></td></tr><tr><td><strong>Integrations</strong><br>Connect Kenko to payments, calendars, and marketing tools.</td><td><a href="/broken/spaces/i5uRkeW8EPGpQhS9SwGb/pages/HGycDfacc9gT7Bz7mkAL">Broken link</a></td></tr></tbody></table>

### Browse

* **Fill more sessions** with better timing and targeting.
* **Convert more leads** with automated follow‑ups.
* **Increase retention** with lifecycle messaging.
* **Lift average order value** with upgrades and add‑ons.

### What you can unlock

{% hint style="info" %}
If you’re brand new: start with **Quickstart**, then skim **Platform Overview**.
{% endhint %}

It does this by turning your data into automated action.

It helps you unlock revenue you didn’t realize you had.
...
* Guides: [Setup Guides](guides/setup-guides/), [Grow Your Studio with Journeys](guides/grow-your-studio-with-journeys/)
* FAQs: [Classes & Scheduling](faqs/classes-and-scheduling/), [Memberships & Subscriptions](faqs/memberships-and-subscriptions/), [Payments & POS](faqs/payments-and-pos/)
* Integrations: [Marketing Meta Pixel](integrations/marketing-meta-pixel.md), [Marketing Google Analytics](integrations/marketing-google-analytics.md), [Marketing Zapier](integrations/marketing-zapier.md)
